...
class AuthHandler:
    ...
    def set_bearer_token(self, token: str | None = None, token_env: str | None = None) -> None:
        """
    ...
    def set_api_key(
        self, api_key: str | None = None, key_env: str | None = None, header_name: str = "X-API-Key"
    ) -> None:
        """
    ...
    def get_basic_auth_tuple(self) -> tuple | None:
        """
...
def create_auth_from_config(auth_config: dict[str, str]) -> AuthHandler | None:
    """
